...
var createProjectHTML = function createProjectHTML(projectObject) {
  return "\n      <div class=\"grid-section\">\n            <div class=\"image-title\">".concat(projectObject.title, "</div>\n            <img class=\"proj-bg-img\" src=\"").concat(projectObject.image, "\" alt=\"").concat(projectObject.title, "\">\n            <div><p class=\"image-description\">").concat(projectObject.text, "\n        </p>\n        <p class=\"techstack\">").concat(projectObject.techstack, "\n        </p>\n        <div>\n        <div class=\"icon-container\"><a href=\"").concat(projectObject.openGithub, "\" target=\"_blank\"><i class=\"code far fa-file-code fa-2x\"></i></a>\n        <a href=\"").concat(projectObject.openPage, "\" target=\"_blank\"><i class=\"code fas fa-rocket fa-2x\"></i></a></div>\n        </div>\n      ");
};
