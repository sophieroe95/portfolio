const projects = [{
  ...
  },
  {
    ...
    techstack: "*Github code not yet available*.Tech Stack: ReactJS, jQuery, CSS, Sass, Font Awesome, Google Maps API, Authentication and Authorisation, Private Routing, Firestore - CRUD, Unit testing (Enzyme), Trello, SCRUM, Agile Working .",
